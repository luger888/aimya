package caurina.transitions.properties {
	...
	public class TextShortcuts {
		...
		public static function init(): void {
			...
			/* updated to include _htmlText shortcut by Gerry Creighton @ thespikeranch.com 11-20-08 */
			Tweener.registerSpecialProperty("_htmlText", _htmlText_get, _htmlText_set, null, _htmlText_preProcess);
	//		Tweener.registerSpecialPropertyModifier("_text", _text_modifier, _text_get);
		...
		public static function _htmlText_get (p_obj:Object, p_parameters:Array, p_extra:Object = null):Number {
			//return p_obj._currentFrame;
			return -p_obj.htmlText.length;
		}
		/**
		...
		public static function _htmlText_set (p_obj:Object, p_value:Number, p_parameters:Array, p_extra:Object = null): void {
			//p_obj.gotoAndStop(Math.round(p_value));
			//p_obj.text =
			if (p_value < 0) {
				// Old text
				p_obj.htmlText = p_extra.oldText.substr(0, -Math.round(p_value));
			} else {
				// New text
				p_obj.htmlText = p_extra.newText.substr(0, Math.round(p_value));
			}
		}
		...
		public static function _htmlText_preProcess (p_obj:Object, p_parameters:Array, p_originalValueComplete:Object, p_extra:Object): Number {
			p_extra.oldText = p_obj.htmlText;
			p_extra.newText = p_originalValueComplete;
			return p_extra.newText.length;
		}
