...
class LessonController extends Zend_Controller_Action
{
    ...
    public function uploadAction()
    {
        ...
        if (isset($_FILES['Filedata']['name']) && $_FILES['Filedata']['name'] != '') {
            ...
            exec("sudo /usr/local/bin/conv.sh /var/www/aimya/Aimya/public/users/54/335/presentation/Svitla_Presentation_Kyiv2011.PPT", $convResult);
