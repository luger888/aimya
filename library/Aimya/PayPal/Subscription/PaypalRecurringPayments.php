...
class Aimya_PayPal_Subscription_PaypalRecurringPayments extends Aimya_PayPal_Subscription_Request_PaypalBase {
    ...
    public function getBillingDetails(&$resultData = array()) {
        ...
        $details = new Aimya_PayPal_Subscription_PaypalBillingDetails();
