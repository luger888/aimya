...
class Aimya_PayPal_Subscription_Request_PaypalBase {
    
    protected $gateway;
    protected $endpoint = '/nvp';
    
    public function __construct(Aimya_PayPal_Subscription_Request_PaypalGateway $gateway) {
        $this->gateway = $gateway;
    }
    
    protected function response($data){
        $request = new Aimya_PayPal_Subscription_Request_HTTPRequest($this->gateway->getHost(), $this->endpoint, 'POST', true);
